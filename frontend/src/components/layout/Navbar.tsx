...
const Navbar = () => {
  ...
  return (
    <>
      <motion.nav 
        className="bg-dark-card border-b border-dark-border px-6 py-4 backdrop-blur-lg relative z-30"
        initial={{ y: -100 }}
        animate={{ y: 0 }}
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="relative">
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span className="absolute -top-1 -right-1 w-4 h-4 bg-neon-magenta rounded-full animate-pulse flex items-center justify-center">
            ...
            <div className="relative">
              ...
              >
                <Avatar user={user} size="sm" className="border-2 border-neon-cyan" />
                <div className="text-left min-w-0">
                  <p className="text-sm font-medium text-white truncate max-w-32">{user?.name}</p>
                  <p className="text-xs text-neon-cyan capitalize truncate max-w-32">{user?.membership}</p>
                </div>
              </motion.button>
                ...
                >
                  <div className="py-2">
                    <Link 
                      ...
                      className="w-full flex items-center space-x-3 px-4 py-2 text-left text-gray-300 hover:bg-dark-bg hover:text-white transition-colors duration-300"
                    >
